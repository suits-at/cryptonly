...
export default {
  ...
  mounted() {
    axios
      .get(
        `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=${this.per_page}&page=${this.page}&sparkline=false&price_change_percentage=1h%2C24h%2C7d`
      )
      .then(response => {
